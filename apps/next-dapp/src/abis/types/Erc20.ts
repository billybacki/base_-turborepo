...
export interface Erc20 extends BaseContract {
  ...
  functions: {
    ...
    transfer(_to: string, _value: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    approve(_spender: string, _value: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    transfer(_to: string, _value: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
