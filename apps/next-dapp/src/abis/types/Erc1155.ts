...
export interface Erc1155 extends BaseContract {
  ...
  functions: {
    ...
    setURI(newuri: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    mint(id: BigNumberish, amount: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    setURI(newuri: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    setURI(newuri: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
