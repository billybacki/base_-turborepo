...
export interface EnsRegistrar extends BaseContract {
  ...
  functions: {
    ...
    setOwner(node: BytesLike, owner: string, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
    ...
    setTTL(node: BytesLike, ttl: BigNumberish, overrides?: Overrides & { from?: string }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    setOwner(node: BytesLike, owner: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    setResolver(node: BytesLike, resolver: string, overrides?: Overrides & { from?: string }): Promise<BigNumber>
    ...
    setTTL(node: BytesLike, ttl: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    setOwner(node: BytesLike, owner: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
    ...
    setTTL(node: BytesLike, ttl: BigNumberish, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>
